...
import com.web.mvc.service.LoginService;
...
public class LoginRestController {
    ...
    public ResponseEntity<User> doLogin(@PathVariable("username") String username,
    										@PathVariable("password") String password) {
        System.out.println("Fetching User with username " + username + " and password " + password);
    ...
    public ResponseEntity<User> updateUser(@PathVariable("id") long id, @RequestBody User user) {
        ...
        User currentUser = loginService.findById(id);
